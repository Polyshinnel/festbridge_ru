            ...
            <div class="event-banner__text-wrapper">
                <div class="event-banner__text">
                    ...
                    <div class="event-banner__text-arrow-block">
                        ...
                        <p>Иногда нам всем требуется духовное и физическое восстановление. Наши ретриты в живописнейших уголках ОАЭ помогут вам полностью перезагрузиться через проработки мышления, телесные практики и воссоединение с природой.</p>
                    </div>
                </div>
            ...
            <div class="box-container">
                <div class="content__wrapper">
                    <div class="content__title">
                        <h2>полная перезагрузка через проработку
                            мышления и телесные практики</h2>
                    </div>
                </div>
                <!-- /.content__wrapper -->
            </div>
