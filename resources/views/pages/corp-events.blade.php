            ...
            <div class="event-banner__text-wrapper">
                <div class="event-banner__text">
                    ...
                    <div class="event-banner__text-arrow-block">
                        ...
                        <p>Многолетний опыт и профессиональная команда позволяют нам проводить яркие корпоративные мероприятия любого масштаба. </p>
                    </div>
                </div>
            ...
            <div class="box-container">
                <div class="content__wrapper">
                    <div class="content__title">
                        <h2>Мы поднимаем корпоративный дух,
                            чтобы поднимались ваши прибыли</h2>
                    </div>
                </div>
                <!-- /.content__wrapper -->
            </div>
