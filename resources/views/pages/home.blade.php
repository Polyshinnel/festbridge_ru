            ...
            <div class="box-container">
                <div class="content__wrapper">
                    <div class="content__title">
                        <h1>О КОМПАНИИ</h1>
                        <p>Fest Bridge East - международная компания, организующая эвенты в ОАЭ. Мы превращаем любое мероприятие в запоминающееся на всю жизнь событие.</p>
                    </div>
                    <div class="content__counters">
                        ...
                        <div class="content__counter">
                            ...
                            <span class="text">мероприятий</span>
                        </div>
                        <!-- /.content__counter -->

                        <div class="content__counter">
                            <span class="number">15 000</span>
                            <span class="text">участников</span>
                        </div>
                        <!-- /.content__counter -->
                    </div>
                </div>
                        ...
                        <div class="our-services__item-wrapper-unit">
                            ...
                            <div class="our-services__item-wrapper-unit-text">
                                <div class="our-services__item-wrapper-unit-text-info">
                                    ...
                                    <p>корпоративы / тим-билдинги / выставки / кейтеринг</p>
                                </div>
                    ...
                    <div class="our-services__item-wrapper">
                        <div class="our-services__item-wrapper-unit">
                            ...
                            <div class="our-services__item-wrapper-unit-text">
                                <div class="our-services__item-wrapper-unit-text-info">
                                    <h3>Фестивали</h3>
                                    <p>фестивали / культурные события</p>
                                </div>
                        ...
                        <div class="our-services__item-wrapper-unit">
                            ...
                            <div class="our-services__item-wrapper-unit-text">
                                <div class="our-services__item-wrapper-unit-text-info">
                                    ...
                                    <p>корпоративные турниры / бизнес-соревнования</p>
                                </div>
                ...
                <div class="our-services__item our-services__item_margin">
                    <div class="our-services__item-wrapper">
                        <div class="our-services__item-wrapper-unit">
                            ...
                            <div class="our-services__item-wrapper-unit-text">
                                <div class="our-services__item-wrapper-unit-text-info">
                                    <h3>Семейные торжества</h3>
                                    <p>свадьбы / дни рождения / детские праздники</p>
                                </div>
                    ...
                    <div class="our-services__item-wrapper our-services__item-wrapper_right">
                        <div class="our-services__item-wrapper-unit">
                            ...
                            <div class="our-services__item-wrapper-unit-text">
                                <div class="our-services__item-wrapper-unit-text-info">
                                    <h3>Ретриты</h3>
                                    <p>частные ретриты / корпоративные ретриты</p>
                                </div>
